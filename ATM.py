...
#By yusuf Yakubu Yusuf yusufyakubuyusuf@gmail.com

#github page - https://github.com/Yusufyyakubu

import time as t
user_pin = 1234
user_balance = 7432.50
user_name = "Yusuf"
choice = 9
...
while (True):
    ...
    print("\t\t4. Change PIN")
    print("\t\t5. Return Card")
    choice = int(input("Please Enter number to proceed > "))
    print("\n\n")
    if choice == 0:
        print("Exiting...")
        t.sleep(4)
        print("You have been logged out, Try again later. Thank you!\n\n") 
        break
        ...
        while (num_of_tries!=0):
            ...
            if input_pin == user_pin:
                ...
                if choice == 1:
                    ...
                    t.sleep(1.5)
                    print("Your current balance is N.", user_balance, end = "\n\n\n")
                    break
                    ...
                    while(True):
                        ...
                        if withdraw_amt>user_balance:
                            print("Can't withdraw N.", withdraw_amt)
                            print("Please enter a lower amount!")
                            continue

                        else:
                            print("Withdrawing N.", withdraw_amt)
                            confirm = input("Confirm? Y/N > ")
                            if confirm in ('Y', 'y'):
                                user_balance-=withdraw_amt
                                print("Amount withdrawn - N.", withdraw_amt)
                                print("Remaining balance - N.", user_balance, end = "\n\n\n")
                                break
                            else:
                    ...
                    print("Depositing N.", deposit_amt)
                    confirm = input("Confirm? Y/N > ")
                    if confirm in ('Y', 'y'): 
                        user_balance+=deposit_amt
                        print("Amount deposited - N.", deposit_amt)
                        print("Updated balance - N.", user_balance, end = "\n\n\n")
                    else:
                        print("Cancelling transaction...")
                        t.sleep(1)
                        print("Transaction Cancelled!\n\n")
